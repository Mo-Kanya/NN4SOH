...
def plot_and_loss(eval_model, data_source,epoch):
    ...
    pyplot.savefig('/Users/jason/Downloads/transformer-time-series-prediction-master/graph/transformer-epoch%d.png'%epoch)
    pyplot.close()
...
def predict_future(eval_model, data_source,steps):
    ...
    pyplot.grid(True, which='both')
    pyplot.axhline(y=0, color='k')
    pyplot.savefig('/Users/jason/Downloads/transformer-time-series-prediction-master/graph/transformer-future%d.png'%steps)
    pyplot.close()
