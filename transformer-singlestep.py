...
def create_inout_sequences(input_data, tw):
    ...
    for i in range(L-tw):
        ...
        for j in range(len(train_label)):
            train_label[j] = input_data[output_window+i+tw-1]
...
_,mydata = get_data(r'/Users/jason/NN4SOH/dataset/nasa/RW_Skewed_Low_40C_DataSet_2Post/data/Matlab/RW22.mat')
b=mydata[0:500].data
c=mydata[0:500].capacity
